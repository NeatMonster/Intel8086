...
public class TestMov extends fr.neatmonster.intel8086.tests.Test {
    ...
    public void test88() {
        setRegister("bl", 1);
        execute(0x88, 0b11_011_111);
        assertEquals("MOV REG8,REG8", 1, getRegister("bh"));

        setRegister("bl", 1);
        execute(0x88, 0b00_011_110, 0x42, 0x00);
    ...
    public void test8E() {
        setRegister("bl", 1);
        setRegister("bh", 2);
        execute(0x8e, 0b11_011_011);
        assertEquals("MOV SEGREG,REG16", 513, getRegister("ds"));

        setMemory(0x42, 3);
        setMemory(0x43, 4);
        execute(0x8e, 0b00_011_110, 0x42, 0x00);
